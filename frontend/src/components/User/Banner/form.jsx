...
const Form = () => {
  ...
  const handleClickSearchBtn = () => {
      ...
      return navigate(`/search?depa=${selectedDeparturePoint}&dest=${selectedDestination}&date=${date}`);
  };
  return (
          ...
          <div className="w-[900px]">
            ...
            <div className="w-[100%] flex justify-end px-2 mt-2">
              <button
                ...
                className="right-0 hover:bg-[color:var(--color-primary)] hover:text-white delay-75 duration-300 ease-in-out  border-[1px] border-[color:var(--color-primary)] px-3 py-[2px] rounded"
              >
                Bắt đầu
              </button>
            </div>
